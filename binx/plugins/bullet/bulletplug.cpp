...
//			body->setCenterOfMassTransform(trans);
			...
			// WatIsDeze.
			//
			// These properties seem to do way better, objects don't fall through anymore.
...
// WatIsDeze:
// A really messy implementation of Gaffer's Fix Your Timestep, or so, I assume I've done it properly.
//
// It was messy code to begin with. However, it seems way more stable now.
static void QDECL World_Bullet_Frame(world_t *world, double frametime, double gravity)
{
	...
	static double ftTime = 0;

	static double t = 0;
	static double dt = btScalar(1.) / btScalar(240.);
	...
	// Calculate "frametime".
	//time = frametime;
	//ftTime = frametime - lastTime;
	// Need delta values, hence the above hack...
	//lastTime = frametime;
	ftTime = frametime;
	...
	// Con_Printf("=================================\n");
	// Con_Printf("Bullet plugin: \n");
	// Con_Printf("ftTime: %0.7f \n", 		ftTime);
	// Con_Printf("accumulator: %0.7f \n",		 	accumulator);
	// Con_Printf("dt: %0.7f \n",		dt);
	// Con_Printf("t: %0.7f \n",		t);
	// Con_Printf("=================================\n");
			//     double newTime = time();
	...
	//		world->rbe.movelimit = physics_bullet_movelimit.value / world->rbe.step;
			...
			ctx->dworld->stepSimulation(frametime, 16, dt);

//			ctx->dworld->stepSimulation(frametime, 3, dt);
...
// 	Con_Printf("=================================\n");
// 	Con_Printf("Bullet plugin: \n");
// 	Con_Printf("frametime: %0.7f \n", 		frametime);
// 	Con_Printf("time: %0.7f \n",		 	time);
// 	Con_Printf("lastTime: %0.7f \n",		lastTime);
// 	Con_Printf("ftTime: %0.7f \n", 	 	ftTime);
// 	Con_Printf("accumulator: %0.7f \n", 	accumulator);
// 	Con_Printf("t: %0.7f \n", 	t);
// 	Con_Printf("dt: %0.7f \n", 	dt);
// 	Con_Printf("frameCounter: %i \n",	frameCounter);
// 	Con_Printf("=================================\n");
...
// 			//ctx->dworld->stepSimulation(dt, 10, t);
